...
// clientID: optional device identifier for CLIENT_HELLO (empty = generated by the client runtime)
...
func validateStartArgs(carrierName, roomID, _ string, keyHex string) error {
	switch {
	case carrierName == "":
